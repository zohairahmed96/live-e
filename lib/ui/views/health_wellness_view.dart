...
import 'package:liv_e/ui/viewmodels/health_wellness_viewmodel.dart';
...
class _Body extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // --- Medication ---
              Text('Medication',
                  style: TextStyle(fontWeight: FontWeight.w700, fontSize: 11.5.sp, color: const Color(0xFF0B101B))),
              ...
              Container(
                ...
                color: headerBg,
                child: Text('Doctor Visits',
                    style: TextStyle(fontWeight: FontWeight.w700, fontSize: 11.sp, color: const Color(0xFF0B101B))),
              ),
              SizedBox(height: 1.2.h),
              WhiteActionRow(
                leading: Icon(Icons.medical_information_rounded, color: brandBlue, size: 24),
                title: 'Doctor Visits',
                onTap: () {},
              ),
              SizedBox(height: 1.8.h),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _moodButton(context, vm, 1, Icons.sentiment_neutral_rounded),
                    _moodButton(context, vm, 2, Icons.sentiment_dissatisfied_rounded),
                  ],
                ),
              ),
  ...
  Widget _moodButton(BuildContext context, HealthWellnessViewModel vm, int idx, IconData ic) {
